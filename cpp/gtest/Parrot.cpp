...
EuropeanParrot::EuropeanParrot(double voltage) : Parrot(voltage)
{
...
AfricanParrot::AfricanParrot(int numberOfCoconuts, double voltage) : Parrot(voltage), numberOfCoconuts(numberOfCoconuts)
{
